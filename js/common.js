...
(function () {
  var header = $(".js-header"),
    ...
    wrapIcons = header.find(".js-header-wrap-icons"),
  ...
  burger.on("click", function () {
    ...
    wrapIcons.toggleClass("visible");
    bg.toggleClass("show");
  });
  bg.on("click", function () {
    burger.removeClass("active");
    wrap.removeClass("visible");
    wraIcons.removeClass("visible");
  ...
  (function () {
    ...
    slider.on(
      ...
      function (event, slick, currentSlide, nextSlide) {
        ...
        status.html(
          '<span class="status__number">0' +
            i +
            '</span><span class="status__all">0' +
            slick.slideCount +
            "</span>"
        );
      }
